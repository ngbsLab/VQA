...
# os.chdir("C:/Users/woohy/Desktop/bokyung/vis_lstm")
...
def main():
    ...
    vgg_file = open(args.model_path,mode='rb')
    #vgg_file = open('Data/vgg16.tfmodel',mode='rb')
    ...
    image_id_list = [int(x) for x in image_id_list]
    ...
    while idx < len(image_id_list):
        ...
        for i in range(0, args.batch_size):
            ...
            image_file = join('C:/Users/woohy/Desktop/bokyung/data/train2014/', '%s2014/COCO_%s2014_%.12d.jpg'%(args.split, args.split, image_id_list[idx] ))
