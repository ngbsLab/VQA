...
# os.chdir("C:/Users/woohy/Desktop/bokyung")
...
def main():
	...
	parser.add_argument('--image_path', type=str, default = 'C:/Users/woohy/Desktop/bokyung/data/train2014/train2014/COCO_train2014_000000002782.jpg',
                       help='Image Path')
	parser.add_argument('--model_path', type=str, default = 'Data/Models/model46.ckpt',
                       help='Model Path')
	...
	parser.add_argument('--image_dropout', type=float, default=0.5,
                       help='image_dropout')
	parser.add_argument('--data_dir', type=str, default='D:/bk/data',
                       help='Data directory')
	parser.add_argument('--question', type=str, default='남자가 앉아 있는 곳은?',
                       help='Question')
