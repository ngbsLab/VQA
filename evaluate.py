...
def main():
	...
	parser.add_argument('--debug', type=bool, default=False,
                       help='Debug')
	parser.add_argument('--model_path', type=str, default = 'C:/Users/woohy/Desktop/bokyung/data/Models/model199.ckpt',
                       help='Model Path')
	...
	qa_data = data_loader.load_questions_answers(1, args.data_dir)

	print ("Reading fc7 features")
	fc7_features, image_id_list = data_loader.load_fc7_features(args.data_dir, 'val2014')
...
def get_batch(batch_no, batch_size, fc7_features, image_id_map, qa_data, split):
	...
	for i in range(si, ei):
		...
		fc7_index = image_id_map[ float(qa[i]['image_id']) ]
